...
class ListingShowScreen extends StatefulWidget {
  final String listingUUID;

  const ListingShowScreen({Key key, @required this.listingUUID})
      : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return new ListingShowScreenState();
  }
}

class ListingShowScreenState extends State<ListingShowScreen> {
  @override
